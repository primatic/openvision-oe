...
echo -e "Uclan ${NC}- ${GREEN}VuPlus ${NC}- ${GREEN}WeTek ${NC}- ${GREEN}XCore ${NC}- ${GREEN}XP ${NC}- ${GREEN}Xpeed ${NC}- ${GREEN}Xsarius ${NC}- ${GREEN}XT ${NC}- ${GREEN}Xtrend ${NC}- ${GREEN}Zgemma"
echo -e "ALL ${NC}- ${GREEN}Specific"
echo -e ""
...
echo -e "It's a zipped file like ${NC}openvision-enigma2-develop-7.0-rx-${GREEN}$MACHINE$MACHINESPECIFIC${NC}.zip"
