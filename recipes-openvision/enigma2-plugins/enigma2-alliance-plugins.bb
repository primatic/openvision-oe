...
DEPENDS = "\
    ...
    ${@bb.utils.contains("MACHINE_FEATURES", "blindscan-tbs", "blindscan-s2 astra-sm" , "", d)} \
    bluez-alsa \
    bluez-conf \
    bluez-hidd \
...
RDEPENDS_enigma2-plugin-systemplugins-blindscan = "${@bb.utils.contains("MACHINE_FEATURES", "blindscan-tbs", "blindscan-s2 astra-sm" , "", d)}"
