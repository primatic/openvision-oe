...
DEPENDS_enigma2-plugin-extensions-lcd4linux = "png-util enigma2-plugin-extensions-lcd4linux-src"
RDEPENDS_enigma2-plugin-extensions-lcd4linux = "python-icalendar python-pyusb python-codecs python-datetime python-imaging python-textutils python-shell python-ctypes libusb1 python-mutagen python-zlib python-email python-subprocess python-simplejson python-soco"
